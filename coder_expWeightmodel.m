...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [] = coder_expWeightmodel(name, trainSeq, testSeq)
arguments
    name (1,:) char
    trainSeq (1,:) double % needs to be col 
    testSeq  (:,1) double % needs to stay row
end
    N = length(trainSeq);
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    T = initializeCoderMachineS26(name, testSeq,0);
